//
//  TVTopRatedDetailViewController.swift
...
class TVTopRatedDetailViewController: UIViewController {
    ...
    private func fetchData() {
        ServieManager.shared.getTvTopRatedDetail(for: tv) { [weak self] result in
...
extension TVTopRatedDetailViewController: UICollectionViewDataSource {
